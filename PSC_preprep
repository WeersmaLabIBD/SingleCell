...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/08_lane1/")
...
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_08_lane1.tsv', sep = '\t', header = TRUE)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/08_lane2/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_08_lane2_5clusters.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/09_lane1/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_09_lane1.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
#Read dataframe 09 lane1
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/09_lane2/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_09_lane2.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/13_lane1/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_13_lane1.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/13_lane2/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_13_lane2.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/14_lane1/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_14_lane1.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/14_lane2/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_14_lane2.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/15_lane1/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_15_lane1.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/15_lane2/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
dataset <- NormalizeData(dataset, assay = "HTO", normalization.method = "CLR")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_15_lane2.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/16_lane1/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_16_lane1.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
...
dataset_10x<-Read10X("~/Documents/R/SingleCell/Data/Souporcell/16_lane2/")
dataset<-CreateSeuratObject(counts = dataset_10x$`Gene Expression`, project = "PSC")
dataset[['HTO']]<-CreateAssayObject(counts = dataset_10x$`Custom`)
dataset[['ADT']]<-CreateAssayObject(counts = dataset_10x$`Antibody Capture`)
dataset<-subset(dataset, nCount_RNA > 200)
...
barcode <- dataset@assays[["RNA"]]@data@Dimnames[[2]]
seurat_call <- data.frame(HTO, HTO_status, barcode)
souporcell <- read.table(file = '~/Documents/R/SingleCell/Data/Souporcell/clusters_16_lane2.tsv', sep = '\t', header = TRUE)
souporcell <- select(souporcell, c("barcode", "status", "assignment"))
All <- merge(seurat_call, souporcell, by = "barcode", all = F)
rownames(All) <- All$barcode
table(All$HTO, All$assignment)
